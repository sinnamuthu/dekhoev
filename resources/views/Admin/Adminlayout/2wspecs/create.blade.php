      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <!--</button>-->
             <a href="/Admin/2wspecsmodel"><button class="btn btn-primary float-right"><i class="fa fa-plus" aria-hidden="true"></i>Add New</button></a>
          </div>
        </div>
        <!-- Modal -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                    <form action="{{URL::to('/Admin/twowspecs/store')}}" method="POST" enctype="multipart/form-data">
                           {!! csrf_field() !!}
                <table id="example1" class="table table-bordered table-striped">      
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td >{{ $item->model_description}}</td>
                                <td><a href="{{URL::to('/Admin/twowspecs/edit/'.$item->model_id)}}" class="btn btn-primary" role="button">Edit</a></td>
