...
<head>
  ...
  <title>Dekhoev |two wheeler  specs</title>
        ...
        <div class="row">
          <div class="col-12">
            <div class=" mx-5">
              ...
              <form action="{{URL::to('/Admin/twowspecs/update/'.$twowspecs->model_id)}}" method="POST" enctype="multipart/form-data">
                   {!! csrf_field() !!}
                  <div class="form-row ">
                      <!--<input type="hidden" name="model_id" id="model_id" value="{{$twowspecs->model_id}}" id="model_id" />-->
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationCustom01">Make</label>
                      <input type="text" class="form-control py-4" id="validationCustom01" name="vehicle_type" placeholder="Make" maxlength="10" value="{{ $twowspecs->make}}" required>
                    ...
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      ...
                      <input type="text"  class="form-control py-4" id="validationCustom02"name="model_name"  placeholder="Model" maxlength="10" value="{{ $twowspecs->model_name}}" required>
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                    </div>
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      ...
                      <input type="text"  class="form-control py-4" id="validationCustom02" name="model_description" maxlength="75" placeholder="Model Decripition" value="{{ $twowspecs->model_description}}" required>
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                    </div>     
                  ...
                  <div class="form-row">
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      ...
                      <input type="text"  class="form-control py-4" id="validationDefault03" name="version_name" maxlength="20" placeholder="Version Name"  value="{{ $twowspecs->version_name}}" required>
                    </div>
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationDefault04">Special Limited Edition</label>
                      <input type="text"  class="form-control py-4" id="validationDefault04" name="special_limited_edition" maxlength="20" placeholder="Special Limited Edition" value="{{ $twowspecs->special_limited_edition}}" required>
                    </div>
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationDefault05">Fuel</label>
                      <input type="text"  class="form-control py-4" id="validationDefault05" name="Fuel" maxlength="20" placeholder="Fuel" value="{{ $twowspecs->Fuel}}" required>
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationDefault03">Product Launch Date</label>
                      <input type="text"  class="form-control py-4" id="validationDefault03" name="Product_Launch_Date" maxlength="5" placeholder="Product_Launch_Date" value="{{ $twowspecs->Product_Launch_Date}}" required>
                    </div>
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationDefault04">Product Launch Month</label>
                      <input type="text"  class="form-control py-4" id="validationDefault04" name="Product_Launch_Month" maxlength="5" placeholder="Product_Launch_Month" value="{{ $twowspecs->Product_Launch_Month}}" required>
                    </div>
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationDefault05">Product Launch Year</label>
                      <input type="text"  class="form-control py-4" id="validationDefault05" name="Product_Launch_Year" maxlength="5" placeholder="Product_Launch_Year" value="{{ $twowspecs->Product_Launch_Year}}" required>
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationDefault03">Model Year</label>
                      <input type="text"  class="form-control py-4" id="validationDefault03" name="Model_Year" maxlength="5" placeholder="Model_Year" value="{{ $twowspecs->Model_Year}}" required>
                    </div>
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationDefault04">Year of Manufacturing</label>
                      <input type="text"  class="form-control py-4" id="validationDefault04" name="Year_of_Manufacturing" maxlength="5" placeholder="Year_of_Manufacturing" value="{{$twowspecs->Year_of_Manufacturing}}" required>
                    </div>
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationDefault05">Country</label>
                      <input type="text"  class="form-control py-4" id="validationDefault05" name="Country" maxlength="20" placeholder="Country" value="{{ $twowspecs->Country}}" required>
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationDefault03">Trim Level</label>
                      <input type="text"  class="form-control py-4" id="validationDefault03" name="Trim_Level" maxlength="20" placeholder="Trim Level" value="{{ $twowspecs->Trim_Level}}" required>
                    </div>
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationDefault04">Price Ex Showroom</label>
                      <input type="text"  class="form-control py-4" id="validationDefault04" name="Price_Ex_Showroom" maxlength="10" placeholder="Price Ex Showroom" value="{{ $twowspecs->Price_Ex_Showroom}}" required>
                    </div>
                    <div class="col-lg-3 col-12 mb-5 mx-auto ">
                      <label for="validationDefault05">Motor(type)</label>
                      <input type="text" class="form-control py-4" id="validationDefault05" name="Motor_Description" maxlength="75" placeholder="Motor(type)" value="{{ $twowspecs->Motor_Description}}" required>
                    </div>
                  </div>
