      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <!--</button>-->
             <a href="/Admin/3wspecscargonewmodel"><button class="btn btn-primary float-right"><i class="fa fa-plus" aria-hidden="true"></i>Add New</button></a>
          </div>
        </div>
        <!-- Modal -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Three wheeler Cargo specs with default features</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                    <form action="{{URL::to('/Admin/threewcargospecs/store')}}" method="POST" enctype="multipart/form-data">
                           {!! csrf_field() !!}
                <table id="example1" class="table table-bordered table-striped">      
                        ...
                        <tbody>
                                @foreach($threewcargospecs as $item)
                            <tr>
                                <td>{{ $item->model_id}}</td>
                                <td>{{ $item->make}}</td>
                                ...
                                <td><a href="{{URL::to('/Admin/threewcargospecs/edit/'.$item->model_id)}}" class="btn btn-primary" role="button">Edit</a></td>
