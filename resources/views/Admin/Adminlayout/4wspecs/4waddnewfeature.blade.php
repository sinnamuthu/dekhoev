...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
    <div class="mx-5">
      <h2 class="mx-auto">Add New Feature</h2>
</div>
</div>
</section>
    <!-- Main content -->
  ...
  <div class="form-row ">
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      ...
      <input type="text" class="form-control py-4" id="validationCustom01" name="make" placeholder="Make" value="" required>
    ...
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      ...
      <input type="text"  class="form-control py-4" id="validationCustom02"name="model" placeholder="Model" value="" required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      ...
      <input type="text"  class="form-control py-4" id="validationCustom02" name="model_description" placeholder="Model Decripition" value="" required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>     
  ...
  <div class="form-row">
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      ...
      <input type="text"  class="form-control py-4" id="validationDefault03" name="version_name" placeholder="Version Name" required>
    </div>
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      <label for="validationDefault04">Special Limited Edition</label>
      <input type="text"  class="form-control py-4" id="validationDefault04" name="special_limited_edition" placeholder="Special Limited Edition" required>
    </div>
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      <label for="validationDefault05">Fuel</label>
      <input type="text"  class="form-control py-4" id="validationDefault05" name="fuel" placeholder="Fuel" required>
    </div>
  </div>
  <div class="form-row">
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      <label for="validationDefault03">Data Date</label>
      <input type="text"  class="form-control py-4" id="validationDefault03" name="data_date" placeholder="Data Date" required>
    </div>
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      <label for="validationDefault04">Data Month</label>
      <input type="text"  class="form-control py-4" id="validationDefault04" name="data_month" placeholder="Data Month" required>
    </div>
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      <label for="validationDefault05">Data Year</label>
      <input type="text"  class="form-control py-4" id="validationDefault05" name="data_year" placeholder="Data Year" required>
    </div>
  </div>
  <div class="form-row">
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      <label for="validationDefault03">Data Year</label>
      <input type="text"  class="form-control py-4" id="validationDefault03" name="data_year1"placeholder="Data Year" required>
    </div>
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      <label for="validationDefault04">Model Year</label>
      <input type="text"  class="form-control py-4" id="validationDefault04" name="model_year" placeholder="Model Year" required>
    </div>
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      <label for="validationDefault05">Country</label>
      <input type="text"  class="form-control py-4" id="validationDefault05" name="country" placeholder="Country" required>
    </div>
  </div>
  <div class="form-row">
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      <label for="validationDefault03">Trim Level</label>
      <input type="text"  class="form-control py-4" id="validationDefault03" name="trim_level" placeholder="Trim Level" required>
    </div>
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      <label for="validationDefault04">Price Ex Showroom</label>
      <input type="text"  class="form-control py-4" id="validationDefault04" name="price" placeholder="Price Ex Showroom" required>
    </div>
    <div class="col-lg-3 col-12 mb-5 mx-auto ">
      <label for="validationDefault05">Motor(type)</label>
      <input type="text" class="form-control py-4" id="validationDefault05" name="motor" placeholder="Motor(type)" required>
    </div>
  </div>
  <div class="d-flex justify-content-center">
  <button type="button" id='adnew' class="btn btn-primary btn-sm px-5 py-2 " data-toggle="modal" data-target="#exampleModalCenter"><b>Save</b></button>
</div>
  </div>       
