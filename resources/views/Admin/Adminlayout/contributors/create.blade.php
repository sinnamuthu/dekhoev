...
<div class="wrapper">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <input type="radio" onclick="window.location='http://dekoev.rdegi.com/addproduct/';"> <span class="font-weight-bold h5">Do you Want to  Add New Model<span>
      </div>
      <div class="modal-body mx-5">
      <input type="radio" onclick="window.location='http://dekoev.rdegi.com/addproduct/';"> <span class="font-weight-bold h5">Do you Want to  Add New Features<span>
      </div>
      <div class="modal-body mx-5">
      <input type="radio" onclick="window.location='http://google.com/';"> <span class="font-weight-bold h5">Do you Want to edit and add newmodel<span>    
      </div><!-- /.container-fluid -->
    </section>
