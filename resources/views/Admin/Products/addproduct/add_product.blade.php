        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="4wheel" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>4W Specs</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="2wheel" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>2W specs</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="3wheel_cargo" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>3W Cargo</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="3wheel_pass" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>3W Pass</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="Contributors" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content" >
      <div class="container-fluid" >
       ...
       <div class="col-lg-3 col-12"  id="example" style="margin-right= 200px">
         <button type="button" onclick="showStuff('answer1'); return false;" class="btn btn-lg btn-primary" disabled">Add New</button>
       </div> 
          <!-- ./col -->
        </div>
        <!-- /.row -->
  ...
  <div class="row">
     <div class="col-sm">
      ...
      <div class="col-sm">
         ...
         <lable>Version Name</lable>
         <input type="text" ></input>
     </div>
     
      <div class="col-sm">
         <lable>Special Limited Edition</lable>
         <input type="text" ></input>
     </div>
      ...
      <div class="row">
      <div class="col-sm">
         <lable>Data Date</lable>
         <input type="text" ></input>
     </div>
     
      <div class="col-sm">
         <lable>Data Month</lable>
         <input type="text" ></input>
     </div>
     
     <div class="col-sm">
         <lable>Data Year</lable>
         <input type="text" ></input>
     </div>
     </div>
      ...
      <div class="row">
      <div class="col-sm">
         <lable>Trim Level</lable>
         <input type="text" ></input>
     </div>
     
      <div class="col-sm">
         <lable>Price Ex Showroom</lable>
         <input type="text" ></input>
     </div>
     
      <div class="col-sm">
         <lable>Motor(type)</lable>
         <input type="text" class="btn btn-link" ></input>
     </div>
  </span>
    </div>
</div>
