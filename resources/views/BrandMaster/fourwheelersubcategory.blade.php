...
<head>
    ...
    <title>Create a OEM Master</title>
...
<body class="section_admin">
    <div class="container">
        <h2 class="text-center">OEM Two Wheeler Sub Category</h2>
        <div class="row">
            <div class="col-6">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <form action="{{ URL::to('/BrandMaster/create')}}" method="GET">
                            <input type="hidden" id="electriccar" name="category" value="Electric Car">
             ...
             <div class="col-6">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                       <form action="{{ URL::to('/BrandMaster/create')}}" method="GET">
                            <input type="hidden" id="electricsuv" name="category" value="Electric Suv">
                            <button type="submit" class="btn btn-dark" >Select</button>
                        </form>
                    </div>
                </div>
