...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  ...
  <title>Three Wheeler Pass</title>
 ...
 {!! csrf_field() !!}
				...
				<div class="add-vehicle">
					<div class="add-vehicle-in">
						...
						<select class="form-select" name="Model_Id_Threec1" aria-label="Default select example" id="select1" onChange="enable2()">
							...
							@foreach($ThreeWheelerPass as $item)
	 ...
	 <script>
			...
			var select3 = select3.replace(/ /g,"_");
			 ...
			 window.location.href = 'https://dekhoev.com/compare-three-wheeler-pass/'+select1+'-VS-'+select2+'-VS-'+select3;
				...
				var imgr = document.getElementById('select1').value;
		         $.ajax({
	                ...
	                success: function(data) {
						if(data == ""){
							var datas = "/UploadImages/NewModel/Threewheelerpassfeature/3WP.png"+data;							
	                      $("#imager1").attr("src",datas);
						}
	                    if(data !=""){
							var datas = "/UploadImages/NewModel/Threewheelerpassfeature/"+data;
	                      $("#imager1").attr("src",datas);
						}
