...
.autocomplete-active {
 ...
 {!! csrf_field() !!}
		...
		<section class="main-cnt compare-wrap">
				<div class="container">
			<section class="compare-wrap-in section-wrap">
				<section class="row">
	 ...
	 <script>
		...
		function comparefunction() {
			...
			var select3 = select3.replace(/ /g,"_");
			 ...
			 window.location.href = 'https://dekhoev.com/compare-two-wheeler/'+select1+'-VS-'+select2+'-VS-'+select3;
	...
	<script>
		$('#select1').change(function() {        
			...
			// let first = $("#select1 option:selected").text();
  			// console.log(first);                                         
		});
