	...
	<div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
			<form action="/Comparisions-Table-Three-Wheeler-Cargo" method="post">
			    {!! csrf_field() !!}
			    <section class="row">
			 ...
			 <!--<div class="search">-->
				...
				<div class="search-wrap">
				    <form action="" method="get">
				        <section class="row">
						<aside class="item-img col-sm-3"><figure><img src="{{url('/UploadImages/NewModel/Threewheelercargofeature/'. $item->Modelimage)}}" id="text1"></figure></aside>
