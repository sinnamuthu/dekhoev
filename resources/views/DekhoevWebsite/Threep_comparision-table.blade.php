							...
							<ul class="compare-list">
								<li>
									<div class="compare-list-bx">										
									   @if($item->Modelimage =="")
										...
										@endif
										@if($item->Modelimage <> "")
										<figure><img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $item->Modelimage)}}" class="img-fluid"></figure>
										@endif										
								...
								<li>
									...
									@if($item1->Modelimage =="")
										...
										@endif
										@if($item1->Modelimage <> "")
										<figure><img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $item1->Modelimage)}}" class="img-fluid"></figure>
										@endif	
            ...
            <div id="table-scroll" class="table-scroll">
              <div class="table-wrap">
                ...
                @foreach ($user as $values)	
                    ...
                    <td><img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $values->Modelimage)}}" class="img-fluid"></td>
                                <td><img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $values1->Modelimage)}}" class="img-fluid"></td>
                @endforeach
                            @endforeach
					<tr>
                    <td class="fixed-side"><span><img src="{{ url('/UploadImages/NewFeatureMaster/1670304961.3WP OEM.png' ) }}" ></span>OEM Brand</td>
							@foreach ($user as $values)	
                            @foreach ($user1 as $values1)
							...
							<ul class="compare-list">
								...
								<li>
									...
									@if($item2->Modelimage =="")
										...
										@endif
										@if($item2->Modelimage <> "")
										<figure><img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $item2->Modelimage)}}" class="img-fluid"></figure>
										@endif	
                  ...
                  <tbody>
                   ...
                   @php
                                     ...
                                     $dbname = "dekhoevdb";
                                        ...
                                        //second comparision
                                        $sql1 = "SELECT * FROM threewheelerpassfeatures WHERE id='$Model_Id_Threec3'";
                                            $result1 = $conn->query($sql1);
                                            if ($result1->num_rows > 0) {
                                                while ($row1 = $result1->fetch_assoc()) {
                                                echo' 
                    ...
                    <tr class='mobile_view'>
						<td class="fixed-side "><span></span></td>
                            ...
                            @foreach ($user2 as $values2)
    						   <td><figure><img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $item->Modelimage)}}" class="img-fluid"></figure></td>
                               <td><figure><img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $item1->Modelimage)}}" class="img-fluid"></figure></td>
                               <td><figure><img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $item2->Modelimage)}}" class="img-fluid"></figure></td>
						   @endforeach
                           @endforeach
                           @endforeach
