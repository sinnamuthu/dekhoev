	...
	<div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
			<form action="/Comparisions-Table-Three-Wheeler-Pass" method="post">
			    {!! csrf_field() !!}
			    <section class="row">
			 ...
			 <!--<div class="search">-->
				...
				<div class="search-wrap">
				    <form action="" method="get">
				        <section class="row">
						<aside class="item-img col-sm-3"><figure><img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $item->Modelimage)}}" id="text1"></figure></aside>
						<aside class="item-cnt col-sm-9">
							<div class="item-cnt-in">
							    <input type="hidden" name="Threec" id="Threec" value={{$item->Model_Name}}>
    							<p>{{$item->Model_Name}}</p>
    							<p class="grn">{{$item->Price}}</p>	
							</div>					
						</aside>
