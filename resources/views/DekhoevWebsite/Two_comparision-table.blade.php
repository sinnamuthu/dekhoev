            ...
            <div id="table-scroll" class="table-scroll">
              <div class="table-wrap">
                ...
                @foreach ($user as $values)	
                    ...
                    <td><img src="{{url('/UploadImages/NewModel/Twowheelerspecsfeature/'. $values->Modelimage)}}" class="img-fluid"></td>
                                <td><img src="{{url('/UploadImages/NewModel/Twowheelerspecsfeature/'. $values1->Modelimage)}}" class="img-fluid"></td>
                @endforeach
                            @endforeach
                            </tr>
                    <tr>
                    ...
                    <tr class='mobile_view'>
						<td class="fixed-side "><span></span></td>
                            ...
                            @foreach ($user2 as $values2)
    						   <td><figure><img src="{{url('/UploadImages/NewModel/Twowheelerspecsfeature/'. $item->Modelimage)}}" class="img-fluid"></figure></td>
                               <td><figure><img src="{{url('/UploadImages/NewModel/Twowheelerspecsfeature/'. $item1->Modelimage)}}" class="img-fluid"></figure></td>
                               <td><figure><img src="{{url('/UploadImages/NewModel/Twowheelerspecsfeature/'. $item2->Modelimage)}}" class="img-fluid"></figure></td>
						   @endforeach
                           @endforeach
                           @endforeach
