			...
			<section class="search-bikes-wrap ashBg">
				<div class="container">
					<section class="search-bikes brand four"><!--wheeler-->
						<h2 class='headtitle'>Search EV Cars & EV SUV s BRANDS</h2>
							<section class="row">
								...
								<aside class="col-md-4">
									<div >
										<div class="hm-gyaan-bx gyaan">
											...
											<!-- <button  class="btn btn-info btn-sm  postbutton sharebutton" id="{{ url('Gyaan/'.$gettitle)}}"  data="{{$values->Posttitle}}"> <a href="#" class="btn-link"> Share >></a></button> -->
