	 ...
	 <section class="wrapper">
		...
		<section class="main-cnt">
			<section class="search-bikes-wrap ashBg">
				<div class="container">
					<section class="search-bikes brand"><!--wheeler-->
						<h2 class='headtitle'>Search EV Scooters & EV Bikes Brand</h2>
							<section class="row">
			...
			<section class="electric-bikes-wrap section-wrap-top"><!--Electric Bikes-->
				<div class="container">
					<h2 class='headtitle'>Electric Bikes in India</h2>
					<section class="row">
					    ...
					    @foreach($twowspecs as $values)
    						...
    						<!-- <aside class="col-md-3">
						        <div class="electric-bike-bx">
									...
									<figure><img src="{{ url('/UploadImages/NewModel/Twowheelerspecsfeature/2W.png')}}" alt="{{$values->altimageget}}" class="img-fluid productimage"></figure>                                       
							        @endif 
									@if($values->Modelimage <>"")
        								<figure><img src="{{ url('/UploadImages/NewModel/Twowheelerspecsfeature/'. $values->Modelimage)}}" alt="{{$values->altimageget}}" class="img-fluid productimage"></figure>
									@endif 	
							...
							<aside class="col-md-3">
						        <div class="electric-bike-bx">
							        ...
							        @endif 
									@if($values->Modelimage <>"")
        								<figure><img src="{{ url('/UploadImages/NewModel/Twowheelerspecsfeature/'. $values->Modelimage)}}" alt="{{$values->altimageget}}" class="img-fluid productimage">
										</figure>
									@endif 	
										<p class=" tl font-16">{{$values->Model_Name}} - {{$values->Model_Description}}</p>
										<br>
										...
										$Model_Name = str_replace(" ","_",$values->Model_Name);
											...
											?><a href="#" class='postbutton productshare sharebutton' style='margin-top: 0px !important;'id="{{ url('Two-Wheeler/'.$Model_Name.'-'.$Model_Description)}}" data="{{$values->Model_Name}}-{{$values->Model_Description}}"><img src="https://dekhoev.com/WebsiteImages/share.png" alt="sharebutton" style="width:30px;height:30px;"></a>
										<button class="btn-view view-button"><a href="{{ url('Two-Wheeler/'.$Model_Name.'-'.$Model_Description) }}" class="btn-link">  View Details</a></button>
									</div>
								</div> 
    						</aside>
