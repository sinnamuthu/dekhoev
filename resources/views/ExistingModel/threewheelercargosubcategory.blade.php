        ...
        <div class="row">
            <div class="col-6">
                <div class="card text-center">
                    <h5 class="text-center my-3">L5N</h5>
                    <img src="{{ URL('public/UploadImages/images/ThreewheelerCargo.JPG') }}" alt="threewheelcargo-L5N" class="img-fluid">
                    <div class="card-body">
                        <form action="{{ URL::to('/ExistingModel/create')}}" method="GET">
                            <input type="hidden" id="L5N" name="category" value="L5N">
             ...
             <div class="col-6">
                <div class="card text-center">
                     <h5 class="text-center my-3">E-Cart</h5>
                    <img src="{{ URL('public/UploadImages/images/ThreewheelerCargo.JPG') }}" alt="threewheelcargo-Ecart" class="img-fluid" height="50%">
                    <div class="card-body">
                       <form action="{{ URL::to('/ExistingModel/create')}}" method="GET">
                            <input type="hidden" id="Ecart" name="category" value="Ecart">
                            <button type="submit" class="btn btn-dark" >Select</button>
                        </form>
                    </div>
                </div>
