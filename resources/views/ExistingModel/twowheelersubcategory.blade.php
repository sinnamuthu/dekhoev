...
<head>
    ...
    <title>Make Change to an Exisiting Model</title>
        ...
        <div class="row">
            <div class="col-6">
                <div class="card text-center">
                    <h5 class="text-center my-3">Bike</h5>
                    <img src="{{ URL('public/UploadImages/NewModel/scooter.jpg') }}" alt="Bike" class="img-fluid">
                    <div class="card-body">
                        <form action="{{ URL::to('/ExistingModel/create')}}" method="GET">
                            <input type="hidden" id="bike" name="category" value="Bike">
                            <button type="submit"  id ="btnBike" class="btn btn-dark" >Select</button>
                        </form>
                    </div>
                </div>
            </div>
             <div class="col-6">
                <div class="card text-center">
                     <h5 class="text-center my-3">Scooter</h5>
                    <img src="{{ URL('public/UploadImages/NewModel/scooter.jpg') }}" alt="Scooter" class="img-fluid">
                    <div class="card-body">
                       <form action="{{ URL::to('/ExistingModel/create')}}" method="GET">
                            <input type="hidden" id="scooter" name="category" value="Scooter">
                            <button type="submit"  id="btnScooter" class="btn btn-dark" >Select</button>
                        </form>
                    </div>
                </div>
            </div>
        </div>
          <center><a href="{{url('/ExistingModel/index/')}}"><button  class="return_admin_button my-5 ">Back</button></a></center>
