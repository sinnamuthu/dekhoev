        ...
        <div class="container-fluid ">
                ...
                <div class="feature my-5">
                        ...
                        <div class="card p-5 my-3" id="card1">
                            <div class="row oem_name">
                                ...
                                <div class="col-4">
                                    ...
                                    @foreach($fourwheelerspecs as $value)
                    ...
                    <div class="" style="dispaly:none;">
                       <form action="{{URL::to('/Fourwheelerspecsfeature/update')}}" method="POST" enctype="multipart/form-data">
                       {!! csrf_field() !!}
                       @method('POST')
                    <!--start-->
                    ...
                    @foreach($users as $user)
                                ...
                                <div class="card py-2 my-3" id="card84" style="height:100px;">
                                    <div class="row my-5" style="position:relative;bottom:40px;" >
                                        <div class="col-6">
                                             <div class="input-group mb-3 ">
                                             @if($Value->Modelimage =="")                                      
                                                <figure><img src="{{ url('/UploadImages/NewModel/Fourwheelerspecsfeature/4W.png')}}" class="img-thumbnail"  width="75" height="75" alt="Image"></figure>                                                                               
                                             @endif
                                             @if($Value->Modelimage <>"")  
                                                <img src="{{url('UploadImages/NewModel/Fourwheelerspecsfeature/'. $Value->Modelimage)}}" class="img-thumbnail"  width="75" height="75" alt="Image">
                                             @endif
                                             @if($Value->Front_Modelimage =="")                                      
                                                <figure><img src="{{ url('/UploadImages/NewModel/Fourwheelerspecsfeature/4W.png')}}" class="img-thumbnail"  width="75" height="75" alt="Image"></figure>                                                                               
                                             @endif
                                             @if($Value->Front_Modelimage <>"") 
                                                <img src="{{url('/UploadImages/NewModel/Fourwheelerspecsfeature/'. $Value->Front_Modelimage)}}" class="img-thumbnail"  width="75" height="75" alt="Image">
                                             @endif
                                             @if($Value->Back_Modelimage =="")                                      
                                                <figure><img src="{{ url('/UploadImages/NewModel/Fourwheelerspecsfeature/4W.png')}}" class="img-thumbnail"  width="75" height="75" alt="Image"></figure>                                                                               
                                             @endif
                                             @if($Value->Back_Modelimage <>"")
                                                <img src="{{url('/UploadImages/NewModel/Fourwheelerspecsfeature/'. $Value->Back_Modelimage)}}" class="img-thumbnail"  width="75" height="75" alt="Image">
                                             @endif 
                                             @if($Value->Leftside_Modelimage =="")                                      
                                                <figure><img src="{{ url('/UploadImages/NewModel/Fourwheelerspecsfeature/4W.png')}}" class="img-thumbnail"  width="75" height="75" alt="Image"></figure>                                                                               
                                             @endif
                                             @if($Value->Leftside_Modelimage <>"") 
                                                <img src="{{url('/UploadImages/NewModel/Fourwheelerspecsfeature/'. $Value->Leftside_Modelimage)}}" class="img-thumbnail"  width="75" height="75" alt="Image">
                                             @endif
                                             @if($Value->Rightside_Modelimage =="")                                      
                                                <figure><img src="{{ url('/UploadImages/NewModel/Fourwheelerspecsfeature/4W.png')}}" class="img-thumbnail"  width="75" height="75" alt="Image"></figure>                                                                               
                                             @endif
                                             @if($Value->Rightside_Modelimage <>"")                                      
                                                <img src="{{url('/UploadImages/NewModel/Fourwheelerspecsfeature/'. $Value->Rightside_Modelimage)}}" class="img-thumbnail"  width="75" height="75" alt="Image">
                                             @endif
                                            </div>    
                                        </div>
                                    </div>
                        ...
                        <!--    <a href="{{URL::to('/Fourwheelerspecsfeature/index')}}" title="View 3W Cargo"><button class="btn btn-success btn-sm">4W Specs</button></a>-->
                        <!--</div> -->
                    </div>
                </div>
