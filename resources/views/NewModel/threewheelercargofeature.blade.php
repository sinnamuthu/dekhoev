    ...
    <section class="section_admin new_model">
        <div class="container-fluid ">
                ...
                <div class="feature my-5">
                    ...
                    <!--Model Name-->
                    <form action="{{URL::to('/NewModel/tcargostore/')}}" method="POST" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <div class="card p-5 my-3" id="card1">
                            <div class="row oem_name">
                                ...
                                <div class="col-4">
                                    <select name="OEM_name" id="oem_name" placeholder="Select OEM Brand" required>
                                    <option class="text-center" value="" > Select OEM Brand</option>    
                                     @foreach ($usersc as $userc)
                                        <option  class="text-center" placeholder="Select OEM Brand" required>{{ $userc->new_oem_name }}</option>
                                    @endforeach
                                    </select>
                                 </div>
                                <!-- <div class="col-3">
                    ...
                    <div class="" style="dispaly:none;">
                       <form action="{{URL::to('/Threewheelercargofeature/store')}}" method="POST" enctype="multipart/form-data">
                           {!! csrf_field() !!}
                        ...
                        <!--    {!! csrf_field() !!}-->
                        <!--    <center><button type="submit" class="btn btn-info mt-2 mx-5 " id="save_model" style="width:30%;">3W Crgo</button></center>-->
                        <!--</form>    -->
                        <!-- <div class="text-center mt-5">
                            <a href="{{URL::to('/Threewheelercargofeature/index')}}" title="View 3W Cargo"><button class="btn btn-success btn-sm">3W cargo</button></a>
                        </div> -->
                    </div>
                </div>
