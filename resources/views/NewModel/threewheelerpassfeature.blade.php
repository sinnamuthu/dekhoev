    ...
    <section class="section_admin new_model">
        <div class="container-fluid ">
                ...
                <div class="feature my-5">
                    ...
                    <!--Model Name-->
                    <form action="{{URL::to('/NewModel/storetpass/')}}" method="POST" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <div class="card p-5 my-3" id="card1">
                            <div class="row oem_name">
                                ...
                                <div class="col-4">
                                    <select name="OEM_name" id="oem_name" placeolder="Select OEM Brand" >
                                        <option class="text-center" value="" > Select OEM Brand</option>
                                     @foreach ($usersc as $userc)
                                        <option  class="text-center" placeolder="Select OEM Brand" required>{{ $userc->new_oem_name }}</option>
                                    @endforeach
                                    </select>
                                 </div>
                                <!-- <div class="col-3">
                    ...
                    <div class="" style="dispaly:none;">
                       <form action="{{URL::to('/Threewheelerpassfeature/store')}}" method="POST" enctype="multipart/form-data">
                           {!! csrf_field() !!}
    		        ...
    		        @endif
                        ...
                        <!--    {!! csrf_field() !!}-->
                        <!--    <center><button type="submit" class="btn btn-info mt-2 mx-5 " id="save_model" style="width:30%;">3W Pass</button></center>-->
                        <!--</form>    -->
                         <!-- <div class="text-center mt-5">
                            <a href="{{URL::to('/Threewheelerpassfeature/index')}}" title="View 3W Pass"><button class="btn btn-success btn-sm">3W pass</button></a>
                        </div> -->
                    </div>
                </div>
