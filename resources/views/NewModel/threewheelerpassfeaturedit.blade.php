    ...
    <section class="section_admin new_model">
        <div class="container-fluid ">
                ...
                <div class="feature my-5">
                    ...
                    <!--Model Name-->
                    <form action="{{URL::to('/NewModel/threewheelerpassupdate')}}" method="POST" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <div class="card p-5 my-3" id="card1">
                            <div class="row oem_name">
                                ...
                                <div class="col-4">
                                    <select name="OEM_name" id="oem_name" required>

                                    @foreach($threewheelerpass as $value)
                    ...
                    <div class="" style="dispaly:none;">
                       <form action="{{URL::to('/Threewheelerpassfeature/update')}}" method="POST" enctype="multipart/form-data">
                       {!! csrf_field() !!}
                       @method('POST')
                    <!--start-->
                    @foreach($users as $user)
                            ...
                            <!-- <div class="card py-2 my-3" id="FAQ1">
                                ...
                                <div class="col-3">
                                        <input type="text" name="Question1" id="Question1"  placeholder="Enter Text..."  width="100" height="100"   value="{{ $Value->Question1 }}" >
                                </div>
                                <div class="col-3">
                                        <h4 class="text-center">Answer 1</h4>
                                </div>
                                <div class="col-3">
                                        <input type="text" name="Answer1" id="Answer1"  placeholder="Enter Text..."  width="100" height="100" value="{{ $Value->Answer1}}" >
                                </div>
                            </div>
                            <div class="card py-2 my-3" id="FAQ2">
                                ...
                                <div class="col-3">
                                        <input type="text" name="Question2" id="Question2"  placeholder="Enter Text..." rows="1" cols="100"  value="{{ $Value->Question2 }}">
                                </div>
                                <div class="col-3">
                                        <h4 class="text-center">Answer 2</h4>
                                </div>
                                <div class="col-3">
                                        <input type="text" name="Answer2" id="Answer2"  placeholder="Enter Text..." rows="1" cols="100"  value="{{ $Value->Answer2}}">
                                </div>
                            </div>
                            <div class="card py-2 my-3" id="FAQ3">
                                ...
                                <div class="col-3">
                                        <input type="text" name="Question3" id="Question3"  placeholder="Enter Text..." rows="1" cols="100"  value="{{ $Value->Question3 }}">
                                </div>
                                <div class="col-3">
                                        <h4 class="text-center">Answer 3</h4>
                                </div>
                                <div class="col-3">
                                        <input type="text" name="Answer3" id="Answer3"  placeholder="Enter Text..." rows="1" cols="100"  value="{{ $Value->Answer3}}">
                                </div>
                            </div> -->
                             <!-- <div class="card py-2 my-3" id="FAQ4">
                                ...
                                <div class="col-3">
                                        <input type="text" name="Question4" id="Question4"  placeholder="Enter Text..." rows="1" cols="100"  value="{{ $Value->Question4 }}">
                                </div>
                                <div class="col-3">
                                        <h4 class="text-center">Answer 4</h4>
                                </div>
                                <div class="col-3">
                                        <input type="text" name="Answer4" id="Answer4"  placeholder="Enter Text..." rows="1" cols="100"  value="{{ $Value->Answer4}}">
                                </div>
                            </div>
                            <div class="card py-2 my-3" id="FAQ5">
                                ...
                                <div class="col-3">
                                        <input type="text" name="Question5" id="Question5"  placeholder="Enter Text..." rows="1" cols="100"  value="{{ $Value->Question5 }}">
                                </div>
                                <div class="col-3">
                                        <h4 class="text-center">Answer 5</h4>
                                </div>
                                <div class="col-3">
                                        <input type="text" name="Answer5" id="Answer5"  placeholder="Enter Text..." rows="1" cols="100"  value="{{ $Value->Answer5}}">
                                </div>
                            </div> 
                            ...
                            <div class="card py-2 my-3" id="Highlights">
                                ...
                                <div class="col-3">
                                        <input type="text" name="Highlights" id="Highlights" id="frown" placeholder="Enter Text..." rows="3" cols="100"  value="{{$Value->Highlights}}">
                                </div>
                            </div> -->
                            ...
                            <div class="card py-2 my-3" id="card79" style="height:100px;">
                                ...
                                <!-- <div class="card py-2 my-3" id="card84" style="height:100px;">
                                    <div class="row my-5" style="position:relative;bottom:40px;" >
                                        <div class="col-6">
                                             <div class="input-group mb-3 ">
                                                <img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $Value->Modelimage)}}" class="img-thumbnail"  width="75" height="75" alt="Image">
                                                <img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $Value->Front_Modelimage)}}" class="img-thumbnail"  width="75" height="75" alt="Image">
                                                <img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $Value->Back_Modelimage)}}" class="img-thumbnail"  width="75" height="75" alt="Image">
                                                <img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $Value->Leftside_Modelimage)}}" class="img-thumbnail"  width="75" height="75" alt="Image">
                                                <img src="{{url('/UploadImages/NewModel/Threewheelerpassfeature/'. $Value->Rightside_Modelimage)}}" class="img-thumbnail"  width="75" height="75" alt="Image">
                                             </div>    
                                        </div>
                                    </div>
                                </div> -->
                                <div class="card py-2 my-3" id="card84" style="height:100px;">
                                    <div class="row my-5" style="position:relative;bottom:40px;" >
                                        <div class="col-6">
                                             <div class="input-group mb-3 ">
                                             @if($Value->Modelimage =="")                                      
                                                <figure><img src="{{ url('/UploadImages/NewModel/Threewheelerpassfeature/3WP.png')}}" class="img-thumbnail"  width="75" height="75" alt="Image"></figure>                                                                               
                                             @endif
                                             @if($Value->Modelimage <>"")  
                                                <img src="{{url('UploadImages/NewModel/Threewheelerpassfeature/'. $Value->Modelimage)}}" class="img-thumbnail"  width="75" height="75" alt="Image">
                                             @endif
                        ...
                        <!--end-->
                        <!--<form action="{{URL::to('/Threewheelerpassfeature/index/')}}" method="GET" enctype="mulipart/form-data" >-->
                        <!--    {!! csrf_field() !!}-->
                        <!--    <center><button type="submit" class="btn btn-info mt-2 mx-5 " id="save_model" style="width:30%;">4W Specs</button></center>-->
                        <!--</form>    -->
                        
                        <!-- <div class="text-center mt-5">-->
                        <!--    <a href="{{URL::to('/Threewheelerpassfeature/index')}}" title="View 3W pass"><button class="btn btn-success btn-sm">2W Specs</button></a>-->
                        <!--</div> -->
                    </div>
                </div>
