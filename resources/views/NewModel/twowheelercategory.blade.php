        ...
        <div class="row">
            <div class="col-6">
                <div class="card text-center">
                    ...
                    <img src="{{ URL('public/UploadImages/NewModel/scooter.jpg') }}" alt="electric_car" class="img-fluid">
                    <div class="card-body">
             ...
             <div class="col-6">
                <div class="card text-center">
                    ...
                    <img src="{{ URL('public/UploadImages/NewModel/scooter.jpg') }}" alt="electric_suv" class="img-fluid">
                    <div class="card-body">
                       <form action="{{ URL::to('/Twowheelerspecsfeature/create')}}" method="GET">
