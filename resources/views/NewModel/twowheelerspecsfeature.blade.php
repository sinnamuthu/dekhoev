    ...
    <section class="section_admin new_model">
        <div class="container-fluid ">
                ...
                <div class="feature my-5">
                    ...
                    <!--Model Name-->
                    <form action="{{URL::to('/NewModel/storetwospecs/')}}" method="POST" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <div class="card p-5 my-3" id="card1">
                            <div class="row oem_name">
                                ...
                                <div class="col-4">
                                    <select name="OEM_name" id="oem_name" placeolder="Select OEM Brand" required>
                                        <option class="text-center" name="OEM_name" value=""> Select OEM Brand</option> 
                                     @foreach ($usersc as $userc)
                                        <option  class="text-center" name="OEM_name" required>{{ $userc->new_oem_name }}</option>
                                    @endforeach
                                    </select>
                                 </div>
                                <!-- <div class="col-3">
                                ...
                                <div class="col-3">
                                    <input type="text" name="model_name" id="model_name" id="frown" placeholder="Enter Model Name" required>
                                </div> -->
                               <div class="col-3">
                    ...
                    <div class="" style="dispaly:none;">
                       <form action="{{URL::to('/Twowheelerspecsfeature/store')}}" method="POST" enctype="multipart/form-data">			   
                           {!! csrf_field() !!}
                            ...
                            <!-- <div class="card py-2 my-3" id="Highlights">
                                ...
                                <div class="col-3">
                                        <textarea type="text" name="productdesc" id="productdesc" id="frown" placeholder="Product Description" rows="3" cols="100"  ></textarea>
                                </div>
                            </div>
                            ...
                            <div class="card py-2 my-3" id="card83" style="height:100px;">
                                        <div class="row my-5" style="position:relative;bottom:40px;" >
                                            <div class="col-6">
                                                <div class="input-group mb-3 ">
                                                    <input type="file" class="form-control mx-3" name="sixRightside_Modelimage" id="inputGroupFile02" >
                                                    <label class="input-group-text upload_icon" for="inputGroupFile02">Upload Image</label></div>
                                              ...
                                              <div class="card py-2 my-3" id="Highlights">
                                                ...
                                                <div class="col-3">
                                                        <textarea type="text" name="altimageget6" id="altimageget6" placeholder="Alt Image" id="frown" rows="3" cols="100"  ></textarea>
                                                </div>
                                            </div>
                            ...
                            <div class="card py-2 my-3" id="card83" style="height:100px;">
                                        <div class="row my-5" style="position:relative;bottom:40px;" >
                                            <div class="col-6">
                                                <div class="input-group mb-3 ">
                                                    <input type="file" class="form-control mx-3" name="sevenRightside_Modelimage" id="inputGroupFile02" >
                                                    <label class="input-group-text upload_icon" for="inputGroupFile02">Upload Image</label></div>
                                              ...
                                              <div class="card py-2 my-3" id="Highlights">
                                                ...
                                                <div class="col-3">
                                                        <textarea type="text" name="altimageget7" id="altimageget7" placeholder="Alt Image" id="frown" rows="3" cols="100"  ></textarea>
                                                </div>
                                            </div>
                        ...
                        <!--<form action="{{URL::to('/Twowheelerspecsfeature/index/')}}" method="GET" enctype="mulipart/form-data" >-->
                        <!--    {!! csrf_field() !!}-->
                        <!--    <center><button type="submit" class="btn btn-info mt-2 mx-5 " id="save_model" style="width:30%;">2W Specs</button></center>-->
                        <!--</form>    -->
                        <!-- <div class="text-center mt-5">
                            <a href="{{URL::to('/Twowheelerspecsfeature/index')}}" title="View 2w specs"><button class="btn btn-success btn-sm">2W pass</button></a>
                        </div>     -->
                    </div>
                </div>
