        ...
        {!! csrf_field() !!}
            <h2 class="text-center">Create a New Post</h2>
                ...
                <div class="row my-2">
                    ...
                    <div class="col-6  my-3">
                        <input type="text" name="meta_title" id="title" placeholder="Post title entered to be here">
                    </div>
                    <div class="col-3  my-3">
                    </div>
                </div>
                ...
                <div class="row my-2">
                    ...
                    <div class="col-6  my-3">
                        <input type="text" name="meta_keyword" id="title" placeholder="Post title entered to be here">
                    </div>
                    <div class="col-3  my-3">
                    </div>
                </div>
                <div class="row my-2">
                    ...
                    <div class="col-6  my-3">
                        <input type="text" name="meta_description" id="title" placeholder="Post title entered to be here">
                    </div>
                    <div class="col-3  my-3">
                    </div>
                </div>
